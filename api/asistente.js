...
- Expedientes por entrevista conversacional: NC interna (UNE-EN ISO 9001:2015), NC ambiental (14001:2015), NC seguridad y salud (45001:2023), NC energética (50001:2018), NC del sistema de gestión antisoborno (ISO 37001), trabajo no conforme de laboratorio (ISO/IEC 17025:2017), NC del sistema de gestión para entidades de inspección (ISO/IEC 17020:2012) y de certificación de producto (ISO/IEC 17065:2012), 8D de reclamación de cliente (incl. formato OEM automoción) y respuesta a hallazgos de auditoría. El documento se redacta en vivo campo a campo; todo es editable; exporta a PDF y Word.
- En 17020, 17025 y 17065 Evidran cubre la CAPA DE GESTIÓN de la acreditación (no conformidades, acciones correctivas, mejora continua, respuesta a hallazgos): la parte que las tres normas comparten y que el evaluador revisa siempre. La competencia técnica de la actividad (las inspecciones, los ensayos o los esquemas de certificación en sí) NO la cubre; dilo con claridad si preguntan.
...
- Vigilancia normativa (módulo aparte, se activa por organización; pensado para laboratorios y entidades acreditadas, en especial automoción/homologación): un robot vigila a diario los reglamentos UNECE de tu lista (catálogo R1–R160) y la vigencia de las normas de tu alcance (vigente / nueva edición / anulada); subes el PDF de tu alcance de acreditación (se procesa en tu navegador, no sale de tu equipo) y cada cambio se cruza contra él para decirte si te afecta; análisis de IA por cambio sobre el documento oficial; evidencias de vigilancia registradas y exportables a CSV (lo que ENAC pide como vigilancia continua); avisos por email. Se puede contratar suelto o junto al resto de Evidran.
- App de campo en el móvil (se instala desde el navegador, sin tiendas): captura rápida de una NC en pocos toques, QR por punto de control (el operario escanea y la captura se abre ya rellena), foto de evidencia con la cámara, dictado con el teclado del móvil (el audio no sale del dispositivo) y funcionamiento sin cobertura (se envía solo al recuperar red).
- Conexión MCP (beta, capacidad pionera): el cliente puede conectar SU PROPIA IA (Claude Code, Cursor u otro cliente MCP) al estado real de su calidad y preguntarle desde su entorno; de solo lectura, con los permisos del usuario y token revocable. Ningún otro QMS lo ofrece.
...
A QUIÉN SIRVE: pymes certificadas (o multi-norma) donde una sola persona lleva la calidad; proveedores de automoción (8D/OEM); laboratorios ENAC (17025) — a los que además les vigila la vigencia de las normas de su alcance; entidades de inspección (17020) y de certificación de producto (17065) acreditadas; consultores y auditores con varias empresas; y empresas EN PROCESO de certificarse (montan el sistema ordenado desde el primer día).
